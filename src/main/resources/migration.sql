...
INSERT INTO cliente (id, nombre, apellido, dni, telefono, email, cuil) VALUES
    ...
    (11, 'Antonella', 'Romero', 67890123, '6789-0123', 'aromero@cliente.com', '20-67890123-1'),
    (12, 'Sebastian', 'Gutierrez', 78901234, '7890-1234', 'sgutierrez@cliente.com', '20-78901234-2'),
    (13, 'Santiago', 'Ruiz', 89012345, '8901-2345', 'sruiz@cliente.com', '20-89012345-3'),
    (14, 'Victoria', 'Jimenez', 90123456, '9012-3456', 'vjimenez@cliente.com', '20-90123456-4'),
    (15, 'Francisco', 'Vega', 10234567, '1023-4567', 'fvega@cliente.com', '20-10234567-5'),
    (16, 'Julieta', 'Castro', 11234567, '1123-4567', 'jcastro@cliente.com', '20-11234567-6'),
    (17, 'Bruno', 'Rojas', 12234567, '1223-4567', 'brojas@cliente.com', '20-12234567-7'),
    (18, 'Olivia', 'Cabrera', 13234567, '1323-4567', 'ocabrera@cliente.com', '20-13234567-8'),
    (19, 'Benjamin', 'Mendoza', 14234567, '1423-4567', 'bmendoza@cliente.com', '20-14234567-9'),
    (20, 'Luciana', 'Flores', 15234567, '1523-4567', 'lflores@cliente.com', '20-15234567-0'),
    (21, 'Matias', 'Paz', 16234567, '1623-4567', 'mpaz@cliente.com', '20-16234567-1'),
    (22, 'Sofia', 'Luna', 17234567, '1723-4567', 'sluna@cliente.com', '20-17234567-2'),
    (23, 'Delfina', 'Acosta', 18234567, '1823-4567', 'dacosta@cliente.com', '20-18234567-3'),
    (24, 'Tomas', 'Silva', 19234567, '1923-4567', 'tsilva@cliente.com', '20-19234567-4'),
    (25, 'Isabella', 'Ortega', 20234567, '2023-4567', 'iortega@cliente.com', '20-20234567-5');
INSERT INTO pedido (id, cliente_id, vendedor_id, fecha, total, estado) VALUES
    ...
    (11, 11, 1, '2023-06-14', 11000.0, 'ENTREGADO'),
    (12, 12, 2, '2023-07-20', 14000.0, 'CANCELADO'),
    (13, 13, 3, '2023-08-10', 17000.0, 'ENTREGADO'),
    (14, 14, 4, '2023-09-05', 13000.0, 'PREPARACION'),
    (15, 15, 5, '2023-10-22', 6000.0, 'ENTREGADO'),
    (16, 16, 1, '2023-11-15', 19000.0, 'CANCELADO'),
    (17, 17, 2, '2023-12-25', 16000.0, 'ENTREGADO'),
    (18, 18, 3, '2024-01-10', 8000.0, 'PREPARACION'),
    (19, 19, 4, '2024-02-12', 20000.0, 'ENTREGADO'),
    (20, 20, 5, '2024-03-20', 5000.0, 'CANCELADO'),
    (21, 21, 1, '2024-04-18', 21000.0, 'ENTREGADO'),
    (22, 22, 2, '2024-05-25', 10000.0, 'PREPARACION'),
    (23, 23, 3, '2024-06-30', 9000.0, 'CANCELADO'),
    (24, 24, 4, '2024-07-15', 23000.0, 'ENTREGADO'),
    (25, 25, 5, '2024-08-05', 7000.0, 'PREPARACION'),
    ...
    (31, 11, 2, '2024-04-10', 13200.0, 'CANCELADO'),
    (32, 12, 3, '2024-04-18', 9800.0, 'ENTREGADO'),
    (33, 13, 4, '2024-05-05', 11700.0, 'PREPARACION'),
    (34, 14, 5, '2024-05-20', 15500.0, 'ENTREGADO'),
    (35, 15, 1, '2024-06-10', 6400.0, 'PREPARACION'),
    (36, 16, 2, '2024-06-25', 18900.0, 'ENTREGADO'),
    (37, 17, 3, '2024-07-15', 10500.0, 'CANCELADO'),
    (38, 18, 4, '2024-07-25', 8900.0, 'ENTREGADO'),
    (39, 19, 5, '2024-08-10', 12000.0, 'PREPARACION'),
    (40, 20, 1, '2024-08-20', 9700.0, 'ENTREGADO'),
    (41, 21, 2, '2024-09-05', 13300.0, 'CANCELADO'),
    (42, 22, 3, '2024-09-18', 16200.0, 'ENTREGADO'),
    (43, 23, 4, '2024-10-10', 8700.0, 'PREPARACION'),
    (44, 24, 5, '2024-10-25', 14300.0, 'ENTREGADO'),
    (45, 25, 1, '2024-11-15', 17600.0, 'PREPARACION');
